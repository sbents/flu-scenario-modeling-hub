...
When estimating infections for pessimistic scenarios seasons (B and D), we assumed an initial susceptiblity of 0.85, as dictated by the hub. We also applied a multiplier to weekly ILI x % positive cases observed in 2014-2015 and 2017-2018 to achieve a final attack rate of approximately 30%. We used the resultant amplified weekly infections as our immunity covariate in B and D scenario projections.
